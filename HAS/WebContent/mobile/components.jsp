...
<html>
	<head>
		<title>Home Automation System - Components</title>
	...
	<body>
      ...
      <%@ include file="header.jsp" %>   
         <div class="mcontent">
            <div class="div1">
               <a href="hvac.jsp"><img src="img/mhvac.png"></a>
            </div>
            <div class="div2">
               <a href="security.jsp"><img src="img/msecurity.png"></a>
            </div>
            <div class="div1">
               <a href="lighting.jsp"><img src="img/mlighting.png"></a>
            </div>
            <div class="div2">
            </div>
         </div>
